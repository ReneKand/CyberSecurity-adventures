...
Document practical cybersecurity learning in a structured and transparent way

Track progress over time across different domains (offense, defense, analysis)

Practice clear technical writing and reflection
...
Notes and experiments related to common web vulnerabilities, including:
...
Based on labs, test environments, and learning platforms.
...
Misconfigured Linux / Windows systems

## Tools & Techniques

Personal notes on tools I actively use and experiment with, for example:
...
No content is intended for illegal use

Targets are limited to labs, intentionally vulnerable systems, or owned environments
